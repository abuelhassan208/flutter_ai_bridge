...
abstract class AILogger {
  ...
  void logAgentStart(String agentName, String taskId, {Map<String, dynamic>? contextData});

  /// Called when an Agent completes execution.
  void logAgentEnd(String agentName, String taskId, {bool success = true, Duration? duration});
